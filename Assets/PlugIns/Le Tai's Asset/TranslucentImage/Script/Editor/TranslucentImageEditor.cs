...
namespace LeTai.Asset.TranslucentImage.Editor
{
    ...
    public class TranslucentImageEditor : ImageEditor
    {
        ...
        private SerializedProperty flatten;

        private bool               materialUsedInDifferentSource;
        private SerializedProperty source;
        private SerializedProperty spriteBlending;
        private bool               usingIncorrectShader;
        private SerializedProperty vibrancy;
        ...
        private void OnSourceChanged(TranslucentImage self)
        {
            CheckMaterialUsedInDifferentSource(self);
        }

        private void OnMaterialChanged(TranslucentImage self)
        {
            CheckMaterialUsedInDifferentSource(self);
            CheckCorrectShader(self);
        }
