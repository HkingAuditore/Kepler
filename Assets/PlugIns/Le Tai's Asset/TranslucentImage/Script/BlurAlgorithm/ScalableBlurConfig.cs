...
namespace LeTai.Asset.TranslucentImage
{
    ...
    public class ScalableBlurConfig : BlurConfig
    {
        ...
        /// <summary>
        ///     Half the number of time to process the image. It is half because the real number of iteration must alway be even.
        ///     Using half also make calculation simpler
        /// </summary>
        /// <value>
