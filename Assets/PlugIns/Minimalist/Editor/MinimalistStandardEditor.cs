...
namespace Minimalist
{
    ...
    {
        private static GradientHandle      gradientHandle;
        public static  MinimalistClipboard MClipboard;
        private        bool                drawGradintGizmo, drawRotationGizmo, deawFogGizmo;
        private        Event               guiEvent;
        private        MaterialEditor      matEditor;
        private        Quaternion          previousObjectRotation, previousCameraRotation;

        private Dictionary<string, MaterialProperty> RecorderProps;
        ...
        private void InitializeGradientSpace(Material mat)
        {
        ...
        private void InitializeClipboard()
        {
            if (MClipboard == null)
            {
                var clipboardPath = MinimalistEditorHelper.MinimalistRootDirectory + "MinimalistClipboard.asset";
                MClipboard = EditorGUIUtility.Load(clipboardPath) as MinimalistClipboard;

                if (MClipboard == null)
                {
                    Debug.Log(
                              $"Couldn't find {clipboardPath}, creating one.");

                    var clipboard = ScriptableObject.CreateInstance<MinimalistClipboard>();
                    AssetDatabase.CreateAsset(clipboard, clipboardPath);
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
                ...
                EditorGUILayout.BeginVertical(GUILayout.ExpandWidth(true));
                {
                    ...
                    if (ShowCustomShading)
                    {
                        ...
                        CustomShadingModule(ref showFrontShading, ref _ShowFront, FRONT, ref frontShadingMode,
                                            ...
                                            ref _GradSettings_F, ref _GradientHeight_F, ref _GradientYStartPos_F,
                                            ref _Rotation_F,
                                            "FRONTGRADIENT", "FRONTSOLID", _GizmoPosition_F);
                        CustomShadingModule(ref showBackShading, ref _ShowBack, BACK,          ref backShadingMode,
                                            ref _Shading_B,      ref _Color1_B, ref _Color2_B, ref backGradientSettings,
                                            ref _GradSettings_B,
                                            ref _GradientHeight_B, ref _GradientYStartPos_B, ref _Rotation_B,
                                            "BACKGRADIENT",
                                            "BACKSOLID", _GizmoPosition_B);
                        CustomShadingModule(ref showLeftShading, ref _ShowLeft, LEFT,          ref leftShadingMode,
                                            ref _Shading_L,      ref _Color1_L, ref _Color2_L, ref leftGradientSettings,
                                            ref _GradSettings_L,
                                            ref _GradientHeight_L, ref _GradientYStartPos_L, ref _Rotation_L,
                                            "LEFTGRADIENT",
                        ...
                        CustomShadingModule(ref showRightShading, ref _ShowRight, RIGHT, ref rightShadingMode,
                                            ...
                                            ref _GradSettings_R, ref _GradientHeight_R, ref _GradientYStartPos_R,
                                            ref _Rotation_R,
                        ...
                        CustomShadingModule(ref showTopShading, ref _ShowTop, TOP, ref topShadingMode, ref _Shading_T,
                                            ...
                                            ref _GradientHeight_T, ref _GradientXStartPos_T, ref _Rotation_T,
                                            "TOPGRADIENT", "TOPSOLID",
                                            _GizmoPosition_T);
                        CustomShadingModule(ref showBottomShading, ref _ShowBottom, DOWN, ref bottomShadingMode,
                                            ...
                                            ref _GradSettings_D, ref _GradientHeight_D, ref _GradientXStartPos_D,
                                            ref _Rotation_D,
                    ...
                    ShowColorCorrectionSettings = GUILayout.Toggle(ShowColorCorrectionSettings, "Color Correction",
                                                                   HeaderStyle, GUILayout.Height(20),
                                                                   GUILayout.ExpandWidth(true));
            ...
            if (EditorGUI.EndChangeCheck()) UndoRedoPerformed(properties);
        }
        ...
        {
            var tex = matEditor.TextureProperty(_MainTexture, "Texture");
            if (tex != null)
            {
                ...
                else if (ShadingType == ShadingMode.Gradient)
                {
                    ...
                    EditorGUILayout.BeginHorizontal("Box");
                    {
                        EditorGUILayout.BeginVertical(GUILayout.Width(50));
                        {
                            ...
                            {
                                var temp = Color1.colorValue;
                                Color1.colorValue = Color2.colorValue;
                                Color2.colorValue = temp;
                            }

                            var R = EditorGUILayout.GetControlRect(GUILayout.Height(50), GUILayout.Width(50));
                                ...
                                EditorGUILayout.BeginHorizontal();
                                {
                                                                                  ...
                                                                                  142));
                                    {
                                        ...
                                        else
                                        {
                                            GradHeight.floatValue =
                                                EditorGUILayoutExtended.FloatField(new GUIContent("Falloff"),
                                                                                   GradHeight.floatValue, 70,
                                                                                   GUILayout.Width(EditorGUIUtility
                                                                                                      .currentViewWidth -
                                                                                                   142));
                                            EditorGUILayout.LabelField("Pivot", GUILayout.Width(60));
                                            GradPivot.vectorValue = EditorGUILayout.Vector2Field("",
                                                                                                 GradPivot.vectorValue,
                                                                                                 GUILayout
                                                                                                    .Width(EditorGUIUtility
                                                                                                              .currentViewWidth -
                                                                                                           142));
                                    ...
                                    EditorGUILayout.BeginVertical();
                                    {
                                        EditorGUI.BeginDisabledGroup(!isAnythingSelected());
                                        {
                                                                 ...
                                                                 GUILayout.Height(28)))
                                            {
                                                ...
                                                MClipboard.color1   = Color1.colorValue;
                                                MClipboard.color2   = Color2.colorValue;
                                            }
                                            ...
                                            EditorGUI.BeginDisabledGroup(!MClipboard);
                                            {
                                                                     ...
                                                                     GUILayout.Height(28)))
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        Color1.colorValue     = MClipboard.color1;
                                                        Color2.colorValue     = MClipboard.color2;
                                                    }
                                                }
                                            }
        ...
        {
            var sc = (SceneView) SceneView.sceneViews[0];
        ...
        private void ResetCamera()
        {
            ...
            sc.orthographic = true;
            if (gSpace == GradientSpace.LocalSpace) selectedObject.rotation = previousObjectRotation;
        }

        private void SceneGUI(SceneView _sceneview)
        {
            ...
            if (gradientHandle != null)
            {
                ...
                if (EditorGUI.EndChangeCheck())
                {
                    ...
                    var objPos                                     = selectedObject.position;
        ...
        private bool IsGlobal(GradientSettings settings)
        {
        ...
        private Texture2D GetTexture(Color color1, Color color2, bool Horizontal)
        {
            Texture2D tex;
            ...
            if (Horizontal)
            {
                for (var i = 0; i < 64; i++) cols[i] = Color.Lerp(color1, color2, (float) i / 63);

                tex = new Texture2D(64, 1);
            }
            else
            {
                for (var i = 0; i < 64; i++) cols[i] = Color.Lerp(color2, color1, (float) i / 63);
        ...
        private class GradientSettingsHolder
        {
            public Color            color1;
            public Color            color2;
        ...
        private class GradientHandle : ScriptableObject
        {
        ...
        private bool showFrontShading;
        private bool showBackShading;
        private bool showLeftShading;
        private bool showRightShading;
        private bool showTopShading;
        private bool showBottomShading;

        public bool ZWriteOverride
        {
            get => _ZWriteOverride.floatValue == 1;
        ...
        private bool ShowCustomShading
        {
            ...
            set
            {
                if (value) _ShowCustomShading.floatValue = 1;
        ...
        private bool ShowOtherSettings
        {
            get
            {
                var x = _OtherSettings.floatValue;
                if (x == 0)
                    return false;
                return true;
            }
        ...
        private bool ShowGlobalGradientSettings
        {
            get
            {
                var x = _ShowGlobalGradientSettings.floatValue;
                if (x == 0)
                    return false;
                return true;
            }
        ...
        private bool ShowAmbientSettings
        {
            get
            {
                var x = _ShowAmbientSettings.floatValue;
                if (x == 0)
                    return false;
                return true;
            }
        ...
        private bool realtimeShadow
        {
            get
            {
                var x = _RealtimeShadow.floatValue;
                if (x == 0)
                    return false;
                return true;
            }
        ...
        private bool EnableUnityFog
        {
            get
            {
                var x = _UnityFogEnable.floatValue;
                if (x == 0)
                    return false;
                return true;
            }
        ...
        private bool ColorCorrectionEnable
        {
            get
            {
                var x = _ColorCorrectionEnable.floatValue;
                if (x == 0)
                    return false;
                return true;
            }
        ...
        private bool ShowColorCorrectionSettings
        {
            get
            {
                var x = _ShowColorCorrection.floatValue;
                if (x == 0)
                    return false;
                return true;
            }
        ...
        private ShadingMode frontShadingMode;
        private ShadingMode backShadingMode;
        private ShadingMode leftShadingMode;
        private ShadingMode rightShadingMode;
        private ShadingMode topShadingMode;
        private ShadingMode bottomShadingMode;

        private Cull cullmode
        {
            get => (Cull) _Cull.floatValue;
            set => _Cull.floatValue = (float) value;
        }

        private ZWrite zWrite
        {
            get => (ZWrite) _ZWrite.floatValue;
            set => _ZWrite.floatValue = (float) value;
        }

        private Mode blendingMode
        {
            get => (Mode) _Mode.floatValue;
            set => _Mode.floatValue = (float) value;
        }

        private GradientSpace gSpace
        {
            get => (GradientSpace) _GradientSpace.floatValue;
            set
            {
        ...
        private LightMapBlendingMode lMapBlendMode
        {
            get => (LightMapBlendingMode) _LmapBlendingMode.floatValue;
            set
            {
        ...
        private GradientSettings frontGradientSettings;
        private GradientSettings backGradientSettings;
        private GradientSettings leftGradientSettings;
        private GradientSettings rightGradientSettings;
        private GradientSettings topGradientSettings;
        private GradientSettings bottomGradientSettings;

        #endregion

        #region ShaderProperties

        private MaterialProperty _ShowTexture, _MainTexture, _MainTexturePower;

        private MaterialProperty _ShowCustomShading;

        private MaterialProperty _ShowFront,
            _Shading_F,
            _Color1_F,
            _Color2_F,
            _GradSettings_F,
        ...
        private MaterialProperty _ShowBack,
            _Shading_B,
            _Color1_B,
            _Color2_B,
            _GradSettings_B,
        ...
        private MaterialProperty _ShowLeft,
            _Shading_L,
            _Color1_L,
            _Color2_L,
            _GradSettings_L,
        ...
        private MaterialProperty _ShowRight,
            _Shading_R,
            _Color1_R,
            _Color2_R,
            _GradSettings_R,
        ...
        private MaterialProperty _ShowTop,
            _Shading_T,
            _Color1_T,
            _Color2_T,
            _GradSettings_T,
        ...
        private MaterialProperty _ShowBottom,
            _Shading_D,
            _Color1_D,
            _Color2_D,
            _GradSettings_D,
        ...
        private MaterialProperty _ShowAO,   _AOEnable,       _AOTexture,        _AOColor,   _AOPower, _AOuv;
        private MaterialProperty _ShowLMap, _LmapEnable,     _LmapBlendingMode, _LMColor,   _LMPower;
        private MaterialProperty _ShowFog,  _UnityFogEnable, _HFogEnable,       _Color_Fog, _FogYStartPos, _FogHeight;

        private MaterialProperty _ShowColorCorrection,
        ...
        private MaterialProperty _ShowGlobalGradientSettings,
            _GradientHeight_G,
            _GradPivot_G,
            _Rotation_G,
            _OtherSettings;

        private MaterialProperty _ShowAmbientSettings, _AmbientColor, _AmbientPower;
        private MaterialProperty _RealtimeShadow,      _ShadowColor,  _ShadowInfluence, _ShadowBlend;
        private MaterialProperty _GradientSpace,       _DontMix,      _Cull,            _Mode, _Fade, _ZWriteOverride;
