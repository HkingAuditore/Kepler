...
inline half4 SurfaceCore(half3 worldNormal, half3 worldPos, half3 lightDir, half3 viewDir)
{
    ...
    float rimTransition = smoothstep(rimSpread - _FlatRimEdgeSmoothness * 0.5, rimSpread + _FlatRimEdgeSmoothness * 0.5,
                                     rim);
    ...
    float specularTransition = smoothstep(0.5 - _FlatSpecularEdgeSmoothness * 0.1,
