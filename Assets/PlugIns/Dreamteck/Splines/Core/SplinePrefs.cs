    ...
    public static class SplinePrefs
    {
        ...
        public static void LoadPrefs()
        {
            ...
            defaultComputerSpace =
                (SplineComputer.Space) EditorPrefs.GetInt("Dreamteck.Splines.defaultComputerSpace", 0);
        ...
        private static Color LoadColor(string name, Color defaultValue)
        {
            ...
            var colorString =
                EditorPrefs.GetString(name,
                                      defaultValue.r + ":" + defaultValue.g + ":" + defaultValue.b + ":" +
                                      defaultValue.a);
        ...
        public static void SavePrefs()
        {
            ...
            EditorPrefs.SetString("Dreamteck.Splines.highlightContentColor",
                                  highlightContentColor.r + ":" + highlightContentColor.g + ":" +
                                  highlightContentColor.b + ":" + highlightContentColor.a);
            ...
            EditorPrefs.SetString("Dreamteck.Splines.createPointColor",
                                  createPointColor.r + ":" + createPointColor.g + ":" + createPointColor.b + ":" +
                                  createPointColor.a);
        }
    }
}
