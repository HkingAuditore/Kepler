...
namespace Dreamteck.Splines
{
    ...
    public struct SplinePoint
    {
        ...
        [FormerlySerializedAs("type")] [SerializeField] [HideInInspector]
        private Type _type;
        ...
        private static void GetInterpolatedTangents(SplinePoint a, SplinePoint b, float t, out Vector3 t1,
                                                    out Vector3 t2)
        {
            var P0_1   = (1f - t) * a.position + t * a.tangent2;
            var P1_2   = (1f - t) * a.tangent2 + t * b.tangent;
            var P2_3   = (1f - t) * b.tangent  + t * b.position;
            var P01_12 = (1  - t) * P0_1       + t * P1_2;
            var P12_23 = (1  - t) * P1_2       + t * P2_3;
            t1 = P01_12;
            t2 = P12_23;
        }
