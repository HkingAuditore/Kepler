...
namespace Dreamteck.Splines
{
    ...
    public class ObjectBender : SplineUser
    {
        ...
        [SerializeField] [HideInInspector] private bool _bend;

        [HideInInspector] public BendProperty[] bendProperties = new BendProperty[0];

        [SerializeField] [HideInInspector] private bool _parentIsTheSpline;

        [SerializeField] [HideInInspector] private TS_Bounds bounds;
        ...
        [SerializeField] [HideInInspector] [FormerlySerializedAs("_upVector")]
        ...
        private void GetTransformsRecursively(Transform current, ref List<Transform> transformList)
        {
            ...
            foreach (Transform child in current) GetTransformsRecursively(child, ref transformList);
        }
        ...
        private void GetObjects()
        {
            ...
            for (var i = 0; i < found.Count; i++) CreateProperty(ref newProperties[i], found[i]);
        ...
        private void CalculateBounds()
        {
            ...
            for (var i = 0; i < bendProperties.Length; i++) CalculatePropertyBounds(ref bendProperties[i]);
            for (var i = 0; i < bendProperties.Length; i++) CalculatePercents(bendProperties[i]);
        }
        ...
        private void Bend()
        {
            ...
            for (var i = 0; i         < bendProperties.Length; i++) BendObject(bendProperties[i]);
        }
        ...
        private void BendMesh(Vector3[] vertexPercents, Vector3[] originalNormals, TS_Mesh mesh,
        ...
        {
            base.LateRun();
            for (var i = 0; i < bendProperties.Length; i++) bendProperties[i].Update();
        }
        ...
        public class BendProperty
        {
            ...
            [SerializeField] [HideInInspector] private Mesh originalColliderMesh;

            [SerializeField] [HideInInspector] private Mesh destinationMesh;

            [SerializeField] [HideInInspector] private Mesh destinationColliderMesh;
            ...
            [SerializeField] [HideInInspector] private bool parent;
