...
namespace Dreamteck.Splines.Editor
{
    public class Explorer : SplineTool
    {
        ...
        private GUIStyle             normalRow;
        private List<SplineComputer> sceneSplines = new List<SplineComputer>();
        ...
        public override void Draw(Rect rect)
        {
            ...
            Rect lastRect;
            scroll = EditorGUILayout.BeginScrollView(scroll, GUILayout.Width(rect.width),
            ...
            for (var i = 0; i < sceneSplines.Count; i++)
            {
                ...
                EditorGUILayout.LabelField(sceneSplines[i].name, isSelected ? selectedRow : normalRow,
                ...
                var alwaysDraw = sceneSplines[i].alwaysDraw;
                ...
                var thickness = sceneSplines[i].drawThinckness;
