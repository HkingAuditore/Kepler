...
namespace Dreamteck.Splines.Editor
{
    public class SplineEditor : SplineEditorBase
    {
        ...
        private   float        editLabelAlpha;
        private   Vector2      editLabelPosition = Vector2.zero;
        public    bool         editMode;
        protected string       editorName = "SplineEditor";
        private   bool         emptyClick;
        ...
        public SplineEditor(Matrix4x4 transformMatrix, string editorName)
        {
            ...
            for (var i = 0; i < pointOperations.Count; i++) pointOperationStrings[i + 1] = pointOperations[i].name;
        }
        ...
        public override void DrawInspector()
        {
            ...
            if (editMode)
            {
                if (!gizmosEnabled)
                    EditorGUILayout
                       .HelpBox("Gizmos are disabled in the scene view. Enable Gizmos in the scene view for the spline editor to work.",
                                MessageType.Error);
            ...
            {
                if (GUILayout.Button("Edit")) editMode = true;
            }
        }
        ...
        private void PointPanel()
        {
            ...
            {
                EditorGUILayout.BeginHorizontal();
                var pointOperation = EditorGUILayout.Popup(0, pointOperationStrings);
                if (pointOperation > 0)
                {
        ...
        private void PointMenu()
        {
            ...
            for (var i = 0; i < selectedPoints.Count; i++)
            {
                ...
                if (splineType == Spline.Type.Bezier)
                {
                    ...
                    points[selectedPoints[i]]
                       .SetTangent2Position(GetChangedVector(avgTan2, avgPoint.tangent2,
        ...
        public void FlatSelection(int axis)
        {
            ...
            if (splineType == Spline.Type.Bezier)
                switch (EditorUtility.DisplayDialogComplex("Flat Bezier",
                                                           ...
                                                           "Points Only", "Tangens Only", "Everything"))
                {
                    case 0:
                        flatTangent  = false;
                        flatPosition = true;
            ...
            if (flatPosition)
            {
                ...
                for (var i = 0; i < selectedPoints.Count; i++)
                {
                    ...
                    switch (axis)
                    {
                        case 0:
                            pos.x                              = avg.x;
                            points[selectedPoints[i]].normal.x = 0f;
                            break;
                        case 1:
                            pos.y                              = avg.y;
                            points[selectedPoints[i]].normal.y = 0f;
                            break;
                        case 2:
                            pos.z                              = avg.z;
                            points[selectedPoints[i]].normal.z = 0f;
                            break;
                    }
        ...
        public void MirrorSelection(int axis)
        {
            ...
            {
                case 0:
                    min = max = points[selectedPoints[0]].position.x;
                    break;
                case 1:
                    min = max = points[selectedPoints[0]].position.y;
                    break;
                case 2:
                    min = max = points[selectedPoints[0]].position.z;
                    break;
            }
            ...
            if (mirrorTangents)
            {
                ...
                {
                    case 0:
                        value = points[selectedPoints[0]].tangent.x;
                        break;
                    case 1:
                        value = points[selectedPoints[0]].tangent.y;
                        break;
                    case 2:
                        value = points[selectedPoints[0]].tangent.z;
                        break;
                }
                ...
                {
                    case 0:
                        value = points[selectedPoints[0]].tangent2.x;
                        break;
                    case 1:
                        value = points[selectedPoints[0]].tangent2.y;
                        break;
                    case 2:
                        value = points[selectedPoints[0]].tangent2.z;
                        break;
                }
            ...
            for (var i = 1; i < selectedPoints.Count; i++)
            {
                ...
                {
                    case 0:
                        value = points[selectedPoints[i]].position.x;
                        break;
                    case 1:
                        value = points[selectedPoints[i]].position.y;
                        break;
                    case 2:
                        value = points[selectedPoints[i]].position.z;
                        break;
                }
                ...
                if (mirrorTangents)
                {
                    ...
                    {
                        case 0:
                            value = points[selectedPoints[i]].tangent.x;
                            break;
                        case 1:
                            value = points[selectedPoints[i]].tangent.y;
                            break;
                        case 2:
                            value = points[selectedPoints[i]].tangent.z;
                            break;
                    }
                    ...
                    {
                        case 0:
                            value = points[selectedPoints[i]].tangent2.x;
                            break;
                        case 1:
                            value = points[selectedPoints[i]].tangent2.y;
                            break;
                        case 2:
                            value = points[selectedPoints[i]].tangent2.z;
                            break;
                    }
            ...
            for (var i = 0; i < selectedPoints.Count; i++)
            {
                ...
                if (mirrorTangents)
                {
                    ...
                    {
                        case 0:
                            points[selectedPoints[i]].position.x = value;
                            break;
                        case 1:
                            points[selectedPoints[i]].position.y = value;
                            break;
                        case 2:
                            points[selectedPoints[i]].position.z = value;
                            break;
                    }
                    ...
                    {
                        case 0:
                            points[selectedPoints[i]].tangent.x = value;
                            break;
                        case 1:
                            points[selectedPoints[i]].tangent.y = value;
                            break;
                        case 2:
                            points[selectedPoints[i]].tangent.z = value;
                            break;
                    }
                    ...
                    {
                        case 0:
                            points[selectedPoints[i]].tangent2.x = value;
                            break;
                        case 1:
                            points[selectedPoints[i]].tangent2.y = value;
                            break;
                        case 2:
                            points[selectedPoints[i]].tangent2.z = value;
                            break;
                    }
                }
                else
                ...
                {
                    case 0:
                        points[selectedPoints[i]].normal.x *= -1f;
                        break;
                    case 1:
                        points[selectedPoints[i]].normal.y *= -1f;
                        break;
                    case 2:
                        points[selectedPoints[i]].normal.z *= -1f;
                        break;
                }
