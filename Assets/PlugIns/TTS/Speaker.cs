...
public class Speaker : Singleton<Speaker>
{
    ...
    private GameObject    speakObj;
    private XunFeiOffline xunFei;
    ...
    private void Update()
    {
        if (Input.GetMouseButtonDown(0)) Speak(contentStr);
    }
    ...
    public void Speak(string content, EnumSpeaker speaker = EnumSpeaker.xiaoyan, SpeakType speakType = SpeakType.normal)
    {
        ...
        if (!xunFei) xunFei = speakObj.GetComponent<XunFeiOffline>();
