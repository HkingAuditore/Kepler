...
namespace PostProcessing
{
    ...
    public sealed class Dof : PostProcessEffectSettings
    {
        ...
        [Tooltip(
                    "Convolution kernel size of the bokeh filter, which determines the maximum radius of bokeh. It also affects performances (the larger the kernel is, the longer the GPU time is required).")]
